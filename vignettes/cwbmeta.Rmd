...
The output of the function includes the name of the test (CWB or CWB Adjusted), the bootstrap test p-value.
...
The function `plot_cwb()` lets users plot the distribution of the bootstrap replicates.
