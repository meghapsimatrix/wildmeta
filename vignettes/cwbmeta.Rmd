...
```{r, eval = requireNamespace("future", quietly = TRUE) & requireNamespace("future.apply", quietly = TRUE)}
library(future)
availableCores()
plan(multisession)
...
CWB takes longer with models fit using `metafor::rma.mv()`. Below is an example with 199 bootstrap replications:
