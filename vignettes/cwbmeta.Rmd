...
The `Wald_test_cwb()` function runs within a minute even when using a large number of bootstrap replications. Below is an example with 999 bootstrap replications.
