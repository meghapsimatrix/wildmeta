...
```{r}
getwd()
system.file("pkgdown-key", package = "wildmeta")
file.exists("pkgdown-key")
file.exists(file.path("..","pkgdown-key"))
```

```{r, echo = FALSE}
reps <- if (file.exists(system.file("pkgdown-key", package = "wildmeta"))) 1999L else 99L
```
