...
check_update <- function(mod, check_dfs = TRUE, tol = sqrt(.Machine$double.eps)) {
...
# update_robu.default works for CE models.
...
# update_robu.default works for HE models.
...
# update_robu.default works for user-weighted models.
