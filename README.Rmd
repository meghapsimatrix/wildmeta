...
Huge shout out to my extremely talented friend [RAZ](https://ms-raz.com/) for creating our apt hex sticker. We are also extremely thankful to [Wolfgang Viechtbauer](https://wvbauer.com/doku.php/home) for helping us solve [this issue](https://stat.ethz.ch/pipermail/r-help/2021-November/472977.html) we had with the `update()` function. We also thank Mikkel Vembye for testing our package and giving us very helpful feedback, and [Sangdon Lim](https://sdlim.com/) for helping us debug some issues.
